...
class Voo:
    ...
    def getDiaPartida(self):
        return self.dataDeSaida.strftime("%d/%m/%Y")
    def getHorarioPartida(self):
        return self.dataDeSaida.strftime("%H:%M")

    def getDiaChegada(self):
        return self.dataDeChegada.strftime("%d/%m/%Y")
    def getHorarioChegada(self):
        return self.dataDeChegada.strftime("%H:%M")
