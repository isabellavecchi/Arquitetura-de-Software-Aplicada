...
export const voos = [
  {
    ...
    partida: "uberlandia",
    destino: "sao paulo",
    diaPartida: "22/07/2023",
    horarioPartida: "19:00",
    diaChegada: "25/11/2023",
  ...
  {
    id: "3",
    partida: "belo horizonte",
    destino: "sao paulo",
    diaPartida: "20/07/2023",
...
export const RenderAeroportosSelect = (aeroporto, index) => {
  return (
    <option value={aeroporto.id}>
      {" "}
      Aeroporto : {aeroporto.nomeAeroporto} em {aeroporto.cidade} -{" "}
      {aeroporto.estado}{" "}
    </option>
  );
};
export const RenderVoosSelect = (voo, index) => {
  return (
    <option value={voo.id}>
      De {voo.partida} à {voo.destino} no dia: {voo.dia} as {voo.horario} por{" "}
      {voo.valor}{" "}
    </option>
  );
};
    ...
    <>
      <tr key={index}>
        ...
        <td className="d-flex flex-row">
          <Button className="mx-1" variant="info" onClick={handleShow3}>
            <FaPen color="white" />
          </Button>
          <Button
            className="mx-1"
            variant="danger"
            onClick={handleSubmit(deletaVoo)}
          >
            <AiOutlineClose />{" "}
          </Button>
        </td>
        ...
        <Modal.Body>
          <Form>
            <Form.Group className="mb-3" controlId="formBasicEmail">
              ...
              <Form.Control
                type="text"
                placeholder="novo local de partida"
                {...register("partida", { required: true })}
              />
            </Form.Group>
            ...
            <Form.Group className="mb-3" controlId="formBasicPassword">
              ...
              <Form.Control
                type="text"
                placeholder="novo local de destino"
            ...
            <Form.Group className="mb-3" controlId="formBasicPassword">
              ...
              <Form.Control
                type="date"
                placeholder="Dia"
                {...register("diaPartida", { required: true })}
              />
            </Form.Group>

            <Form.Group className="mb-3" controlId="formBasicPassword">
              <Form.Label>
                Horario de partida Atual: ({voo.horarioPartida})
              </Form.Label>
              <Form.Control
                type="time"
                placeholder="novo Horario de Partida"
                {...register("horarioPartida", { required: true })}
              />
            </Form.Group>
            <Form.Group className="mb-3" controlId="formBasicPassword">
              ...
              <Form.Control
                type="date"
                placeholder="Dia"
                {...register("diaChegada", { required: true })}
              />
            </Form.Group>
            <Form.Group className="mb-3" controlId="formBasicPassword">
              <Form.Label>
                Horario de chegada Atual: ({voo.horarioChegada})
              </Form.Label>
              <Form.Control
                type="time"
                placeholder="novo Horario de Chegada"
                {...register("horarioChegada", { required: true })}
              />
            </Form.Group>
            <Form.Group className="mb-3" controlId="formBasicPassword">
              ...
              <Form.Control
                type="number"
                placeholder="novo Horario de Chegada"
                {...register("passagens", { required: true })}
              />
            </Form.Group>
            ...
            <Form.Group className="mb-3" controlId="formBasicPassword">
              ...
              <Form.Control
                type="number"
                placeholder="novo valor de passagem"
              />
            </Form.Group>
          </Form>
          <Modal.Footer>
        ...
        <Modal.Body>
          <Form>
            ...
            <Form.Group className="mb-3" controlId="horarioPartida">
              ...
              <Form.Control
                type="time"
                placeholder="Horario da Partida"
                {...register("horarioPartida", { required: true })}
              />
            </Form.Group>
            ...
            <Form.Group className="mb-3" controlId="horarioChegada">
              ...
              <Form.Control
                type="time"
                placeholder="Horario da Chegada"
                {...register("horarioChegada", { required: true })}
              />
            </Form.Group>
