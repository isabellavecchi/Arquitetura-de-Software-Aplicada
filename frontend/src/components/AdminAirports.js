...
export const aeroportos = [
  ...
  {
    id: "2",
    nomeAeroporto: "jaci de assis",
    cidade: "rio de janeiro",
    estado: "RJ",
  },
  {
    id: "3",
    nomeAeroporto: "getulio vargas",
    cidade: "Pirapora",
    estado: "MG",
  },
  {
    id: "4",
    nomeAeroporto: "santos drumond",
    cidade: "sao paulo",
    estado: "SP",
  },
];
    ...
    <>
      <tr key={index}>
        ...
        <td>
          ...
          <Button
            onClick={handleSubmit(deletaAeroporto)}
            className="mx-1"
            variant="danger"
          >
            <AiOutlineClose />{" "}
          ...
          {aeroportos
            .filter((aeroporto) => {
              return search.toLowerCase() === ""
                ? aeroporto
                : aeroporto.nomeAeroporto.toLowerCase().includes(search);
            })
          ...
          <Form>
            <Form.Group className="mb-3" controlId="formBasicEmail">
              ...
              <Form.Control
                ...
                {...register("nomeAeroporto", { required: true })}
              />
            </Form.Group>
            <Form.Group className="mb-3" controlId="formBasicEmail">
